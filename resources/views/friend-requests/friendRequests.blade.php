...
@section('content')
    ...
    <div class="px-4 pt-0 pb-4 cover">
        <div class="media align-items-end profile-head">
            <div class="media-body mb-5 text-white">
                <h4 class="mt-0 mb-4">{{__('Friend Requests')}}</h4>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                @foreach($friendRequests as $key => $friend)
                    <div class="col-md-8 col-xl-4">
                        ...
                        <button data-id="{{$friend[0]->id}}" type="button" class= "btn btn-danger ml-2 reject-friend-request"> Reject friend Request</button>
                    </div>
                @endforeach
    ...
    @else
        <div style="text-align: center">
            <h5 class="font-weight-bold mb-0 d-block">No Friend Requests</h5>
        </div>
    @endif
